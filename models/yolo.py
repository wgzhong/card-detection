...
from util import check_anchor_order, make_divisible
from plots import feature_visualization
from util import copy_attr, fuse_conv_and_bn, initialize_weights, model_info, scale_img, \
    time_sync
...
class Detect(nn.Module):
    ...
    def _make_grid(self, nx=20, ny=20, i=0):
        ...
        yv, xv = torch.meshgrid([torch.arange(ny).to(d), torch.arange(nx).to(d)], indexing='ij') # torch>=1.10.0 meshgrid workaround for torch>=0.7 compatibility
