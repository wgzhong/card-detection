# YOLOv5-poker GPL-3.0 license
"""
Train a YOLOv5 model on a custom dataset

Usage:
    $ python path/to/train.py --data poker.yaml --weights yolov5s.pt --img 640
"""
...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    # Batch size
    assert batch_size > 8, f'{batch_size} batch size less 8.' 
